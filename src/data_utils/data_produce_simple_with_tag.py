...
class TrainDataProducer:
    ...
    def __init__(self):
        ...
        self.lish_full_words_dict = dict()
    ...
    def convert_in_words(self, words, rate_threshold):
        ...
        for word in words:
            if word in self.rnn_vocab_dict:
                ...
                word_converted = self.unk_lang_flag
                word_num += 1
    ...
    def make_vocab_map(self):
        ...
        self.in_word_id_dict[self.unk_lang_flag] = self.in_unk_lang_id
        ...
        self.out_word_id_dict[self.unk_lang_flag] = self.out_unk_lang_id
...
if __name__ == "__main__":
    ...
    lish_words_dict_file = args[2]
    word_keys_pair_map = args[3]
    emojis_file = args[4]
    # phrase_file = args[4]
    data_path_in = args[5]
    ...
    data_producer.lish_full_words_dict = data_producer.load_vocab(lish_words_dict_file, "##", "lish full")
